        ...
        <footer className="bg-white border-t border-neutral-100 pt-20 px-6 sm:px-12 overflow-hidden">
            <div className="max-w-7xl mx-auto flex flex-col md:flex-row justify-between items-start gap-12 mb-24">
                ...
                <div className="max-w-md">
                    <p className="font-sans text-3xl md:text-1xl text-[#1a1a1a] leading-tight font-medium mb-55">
                ...
                <div className="flex flex-col sm:flex-row gap-12 sm:gap-44">
                    ...
                    <div className="flex flex-col space-y-4 text-sm text-[#1a1a1a] font-medium tracking-wide">
                        ...
                        <Link href="/about" className="hover:text-black transition-colors relative after:content-[''] after:absolute after:-bottom-1 after:left-0 after:w-0 after:h-[1px] auto after:bg-black after:transition-all hover:after:w-full w-fit mb-30">O nas</Link>
                        <span className="text-neutral-400 font-normal mt-auto pt-4">Created with ❤️ by Jakub Pacocha</span>
